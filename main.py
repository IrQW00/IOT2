...
class SmartLampApp:
    def __init__(self, root, broker="test.mosquitto.org"):
        ...
        # Настройки
        self.light_level = 100  # Начальный уровень освещенности
    ...
    def toggle_auto_mode(self):
        """Переключить режим работы устройства"""
        if self.auto_mode:
            self.auto_mode = False
    ...
    def update_data(self):
        """Обновить данные и отправить их на сервер MQTT"""
        if self.auto_mode:
